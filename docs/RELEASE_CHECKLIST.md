...
- [x] Gold v0.9 resolves all 56 anchors across 41 queries against the 8,081-chunk,
...
- [x] Full-corpus contributor-labelled engineering benchmark recorded in
      `docs/eval_results.md`: provision recall@8 0.9102, chunk recall@8 0.7110, MRR@8 0.5945.
- [x] Three independent runs plus one clean-store rebuild are bit-for-bit identical.
